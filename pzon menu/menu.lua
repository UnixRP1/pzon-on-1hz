...
mainMenu = NativeUI.CreateMenu("Main Menu", "~r~Pzon on 1 Hz")
...
function SecondItem(menu) 
    local click = NativeUI.CreateItem("Heal me", "~r~Heal yourself")
    menu:AddItem(click)
...
function FourthItem(menu) 
   local submenu = _menuPool:AddSubMenu(menu, "~r~Sub Menu") 
